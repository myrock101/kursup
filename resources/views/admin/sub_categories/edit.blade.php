    ...
    <form action="{{ route('sub-categories.update', [$subCategory->id]) }}" method="POST">
        ...
        <div class="card-body">
            <div class="row ">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        <label>{{ __('subname_ua') }}</label>
                        <input type="text" name="subname_ua" class="form-control @error('subname_ua') is-invalid @enderror" required
                            maxlength="50" value="{{ old('subname_ua') }}">
                    </div>
                    @error('subname_ua')
                    <x-invalid-feedback> {{ $message }} </x-invalid-feedback>
                    @enderror
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" required
                            maxlength="50" value="{{ old('slug',$subCategory->slug) }}">
                    </div>
                    @error('slug')
                    <x-invalid-feedback> {{ $message }} </x-invalid-feedback>
                    @enderror
