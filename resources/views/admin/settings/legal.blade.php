        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 ">
                <form action="{{ route('setting.update') }}" method="POST" autocomplete="off">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <form method="post">
                                <textarea class="textarea-full" name="terms">{{$data[2]['value']}}</textarea>
                            </form>
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12 ">
                <form action="{{ route('setting.update') }}" method="POST" autocomplete="off">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>{{__('Become an authorr')}}</h4>

                        </div>
                        <div class="card-body ">
                            <form method="post">
                                <textarea class="textarea-full" name="autho">{{$data[44]['value']}}</textarea>
                            </form>
                        </div>
                        <div class="card-footer text-right">
                            <button class="btn btn-primary" type="submit">{{__('Submit')}}</button>
            ...
            <div class="col-12 col-md-12 col-lg-12 ">
                <form action="{{ route('setting.update') }}" method="POST" autocomplete="off">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <form method="post">
                                <textarea class="textarea-full" name="c_p">{{$data[0]['value']}}</textarea>
                            </form>
                        </div>
                        <div class="card-footer text-right">
                            <button class="btn btn-primary" type="submit">{{__('Submit')}}</button>
            ...
            <div class="col-12 col-md-12 col-lg-12 ">
                <form action="{{ route('setting.update') }}" method="POST" autocomplete="off">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <form method="post">
                                <textarea class="textarea-full" name="p_p">{{$data[1]['value']}}</textarea>
                            </form>
                        </div>
                        <div class="card-footer text-right">
                            <button class="btn btn-primary" type="submit">{{__('Submit')}}</button>
