    ...
    <div class="col-md-12">
        <!-- <div class="card_dash1">
            ...
            <div class="card_dash_right1">
                <button class="create_btn_dash" onclick="window.location.href = '{{ route('courses.create') }}';">{{__('Create Your Course')}}</button>
            </div>
        </div> -->
    </div>
</div>
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-discount-tab" data-toggle="pill" href="#pills-discount" role="tab"
                        aria-controls="pills-discount" aria-selected="false"><i
                            class="uil uil-tag-alt"></i>{{__('Discountss')}}</a>
                </li>
                <li class="nav-item">
                        ...
                        <table class="table ucp-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span class="text-primary">{{$item->category->name ?? __('No Data')}}</span></td>
                                    <td class="text-center ">
                                        ...
                                        <b class="course_active text-danger">{{ __("Reject")}}<i class="uil uil-info-circle icon-tooltip" data-trigger="manual" data-toggle="tooltip" data-html="true" title="<p style='padding: 5px;color:#fff;'>Публикация курса нарушает <a href='https://kursup.com/legal/rules' target='_blank'>условия пользования сайта</a>.<br> Пожалуйста, проверьте всю заполненную информацию и отправьте повторно на проверку. </p>"></i></b>
                                        @else
                                    ...
                                    <td class="text-center d-flex justify-content-center">
                                        <!-- <a href="{{ route('courses.edit', $item->id) }}" title="{{__('Edit')}}" class="gray-s"><i
                                        ...
                                        @elseif($item->status == 4)
                                            <a href="{{ route('courses.updateStatus',['id'=> $item->id,'status'=> 0]) }}" title="{{__('Back To Draft')}}" class="gray-s"><i class="uil uil-corner-down-left"></i></a>
                                        @endif
                                                ...
                                                <form action="{{ route('special-discount.store') }}" method="post">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="ui search focus mt-20 lbel25">
                                                                ...
                                                                <div class="ui left icon input swdh19">
                                                                    <input class="prompt srch_explore input-no-pr" type="number"
                                                        ...
                                                        <div class="col-lg-12 col-md-12">
                                                            <div class="ui search focus mt-20 lbel25">
                                                                <label>{{__('Title*show')}}</label>
                                                                <div class="ui left icon input swdh19">
                                                                    <input class="prompt srch_explore" type="text" placeholder="{{__('Why you give this discount??')}}" required name="title" value="" max="50">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6">
                        ...
                        <table class="table ucp-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cell-ta">{{$item->course->title ?? __('No Data')}}</td>
                                    <td class="text-center">
                                        {{'C ' . $item->start_time->format('d.m.Y') . ' по ' . $item->end_time->format('d.m.Y')}}
                                    </td>
                                    <td class="text-center">{{$item->percentage}} {{$admin_setting[7]['value']}}</td>
                                    <!-- <td class="text-center">
                                    ...
                                    <td class="text-center d-flex justify-content-center">
                                        <a href="{{ route('special-discount.edit', $item->id) }}" title="{{__('Edit')}}"
                                        ...
                                        <form action="{{ route('special-discount.destroy', $item) }}" method="post">
                                            ...
                                            <a href="#" type="submit"
                                                ...
                                                title="{{__('Delete')}}" class="gray-s"><i class="uil uil-trash-alt"></i></a>
                                        </form>
                        ...
                        <table class="table ucp-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">{{$loop->iteration}}</td>
                                    <td class="cell-ta">{{$item->title}}</td>
                                    <td class="text-center"><a href="https://kursup.com/courses/{{ $item->slug }}"
                                            target="_blank">{{__('View')}}</a></td>
                                    <td class="cell-ta"><span
                                            class="text-primary">{{$item->category->name ?? __('No Data')}}</span></td>
