            ...
            <div class="tab-pane fade @if (!$errors->any()) show active @endif " id="pills-account" role="tabpanel"
                ...
                <div class="account_setting">
                    <form method="post" action="{{ route('profile.updatestu') }}" autocomplete="off"
                        ...
                        <p>{{__('This is your public presence on')}} {{env('APP_NAME')}}. {{__('You need a account to upload your paid courses, comment on courses, purchased by students, or earning.')}}</p>
                        <div class="basic_profile">
                            <div class="basic_ptitle">
                                <h4>{{__('Basic Profile')}}</h4>
                                <p>{{__('Add information about yourself')}}</p>
                            </div>
                            <div class="basic_form container">
                                <div class="">
                                    <div class="col-lg-8">
                                        <div class="row">
                                            <div class="col-lg-6">
