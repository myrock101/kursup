...
<body>
    ...
    <a href="#" onclick="shareOnvk('{{$name}}','{{ $link }}')" class="fab fa-vk"></a>
    <a href="#" onclick="shareOnok('{{$name}}','{{ $link }}')" class="fab fa-odnoklassniki"></a>
    <a href="#" onclick="shareOntg('{{$name}}','{{ $link }}')" class="fab fa-telegram"></a>
    <a href="#" onclick="shareOnmail('{{$name}}','{{ $link }}')" class="fas fa-at"></a>
...
<script>
    "use strict";
    function shareOnmail(name, link) {
		var url = `https://connect.mail.ru/share?url=${link}`;
		window.open(url, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');
		return false;
	}
    function shareOntg(name, link) {
		var url = `https://telegram.me/share/url?url=${link}`;
		window.open(url, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');
		return false;
	}
    function shareOnok(name, link) {
		var url = `https://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st._surl=${link}&st.comments=${name}`;
		window.open(url, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');
		return false;
	}
    function shareOnvk(name, link) {
		var url = `https://vkontakte.ru/share.php?url=${link}&text=${name}`;
		window.open(url, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');
		return false;
	}
