                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="rgt-145">
                                <ul class="tutor_social_links">
                                    @if(!empty($inst->facebook))<li><a href="http://facebook.com/{{$inst->facebook}}" class="fb"><i class="fab fa-facebook-f"></i></a></li>@endif
									@if(!empty($inst->twitter))<li><a href="http://twitter.com/{{$inst->twitter}}" class="tw"><i class="fab fa-twitter"></i></a></li>@endif
									@if(!empty($inst->linkedin))<li><a href="http://www.linkedin.com/{{$inst->linkedin}}" class="ln"><i class="fab fa-linkedin-in"></i></a></li>@endif
									@if(!empty($inst->youtube))<li><a href="http://www.youtube.com/{{$inst->youtube}}" class="yu"><i class="fab fa-youtube"></i></a></li>@endif
                                </ul>
                            </div>
                            <ul class="_bty149">
                                <li>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="cmmnt_1526">
                                            <form action="{{url('author-comment')}}" method="POST">
                                                @csrf
                                                <div class="cmnt_group">
                                                    <div class="img160">
                                                        <img src="
                                                    {{ file_asset(auth('customer')->user()->image ?? 'default.svg') }}"
                                                            alt="">
                                                    </div>
                                        ...
                                        <div class="review_all120">
                                            ...
                                            <div class="review_item">
                                                <div class="review_usr_dt">
                                                    ...
                                                    @if (auth('customer')->user() && auth('customer')->user()->id == $item->student_id)
                                                ...
                                                <div class="rpt101">
                                                    <a href="{{ route('ins.dis.social', ['id'=>$item->id,'action'=>'like']) }}"
                                                        class="report155 {{in_array(auth('customer')->user()->id ?? "0",$item->likes) ? 'text-danger' : '' }}"><i
                                                            class='uil uil-thumbs-up'></i>
                                                        {{count($item->likes)}}</a>
                                                    <a href="{{ route('ins.dis.social', ['id'=>$item->id,'action'=>'dislike']) }}"
                                                        class="report155 {{in_array(auth('customer')->user()->id ?? "0",$item->dislikes) ? 'text-danger' : ''}}"><i
