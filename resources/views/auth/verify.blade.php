                    ...
                    <div class="cmtk_group">
                        ...
                        <div class="cmtk_dt">
                            ...
                            <h4 class="thnk_title1">
                                ...
                                Мы отправили вам письмо на электронную почту</h4>
                                ...
                                <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                    ...
                                    <form class="d-inline" method="POST" action="{{ route('stuverification.resend') }}">
                                        ...
                                        <form class="d-inline" method="POST"
                                            ...
                                            @csrf
                                            <button type="submit"
                                                class="btn btn-link p-0 m-0 align-baseline text-danger">{{ __('click here to request another') }}</button><br/><br/><br/><br/><br/><br/>
                                                <a href="https://kursup.com/" class="btn btn-link p-0 m-0 align-baseline text-danger">Главная страница</a>
                                        </form>
                        </div>
