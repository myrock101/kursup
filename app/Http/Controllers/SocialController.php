...
{
    //
    public function redirectToProvider($user_type = 'customer', $provider = 'google')
    {
    ...
    public function handleProviderCallback($provider)
    {
        ...
        $ut = Session::get("user_type") ?? 'customer';
        if ($ut == 'author') {
        ...
        if ($ut == 'author') {
            return redirect()->to('/author/home')->withStatus(__('We Happy to see you.'));
        }else {
