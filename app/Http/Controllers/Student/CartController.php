...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        $courses = Course::whereIn('id', Cart::where('student_id', Auth::id())->latest()->get()->pluck('course_id'))->whereStatus(1)->get();
        ...
        foreach ($courses as $course) {
            ...
            if ($course->is_free == 0) {
                ...
                if (!$sd) {
                    ...
                    $d = $course->price - $sd['percentage']; // dis
                    $course->discount_price = $d;
                    $discount += $d; // dis
                    $fp = $d;

                    $total += $course->price; // $course->price;
